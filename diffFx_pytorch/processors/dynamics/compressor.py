...
class Compressor(ProcessorsBase):
    ...
    This processor implements a feedforward dynamic range compressor with configurable
    knee curves and envelope following methods. The compressor implements dynamic range
    compression using level detection, smoothing, and gain computation stages.
    ...
    Note:
        The processor supports the following parameter ranges:
            ...
            - attack_ms: Attack time in ms (1 to 500)
            - release_ms: Release time in ms (10 to 2000)
            - makeup_db: Makeup gain in dB (-24 to 24)
    ...
    """
    def __init__(self, sample_rate=44100, knee_type="quadratic", smooth_type="ballistics"):
    ...
    def _register_default_parameters(self):
        ...
        Sets up the following parameters with their ranges:
            ...
            - attack_ms: Attack time (1 to 500 ms)
            - release_ms: Release time (10 to 2000 ms)
        ...
        self.params = {
            ...
            'attack_ms': EffectParam(min_val=1.0, max_val=500.0),
            'release_ms': EffectParam(min_val=10.0, max_val=2000.0),
...
class MultiBandCompressor(ProcessorsBase):
    ...
    """
    def __init__(self, sample_rate, num_bands=3, knee_type="quadratic", smooth_type="ballistics"):
...
class Limiter(Compressor):
    ...
    def _register_default_parameters(self):
        ...
        self.params = {
            'threshold_db': EffectParam(min_val=-60.0, max_val=0.0),
            'ratio': EffectParam(min_val=20.0, max_val=1000.0),
